...
ansible-playbook playbooks/ue-content-start.yml -e "ndisplay_map=/Game/Path/To/Map"
```
...
- **`playbooks/ue-content-start.yml`** -- launch nDisplay cluster via command line.
- **`playbooks/ue-content-stop.yml`** -- stop nDisplay cluster.
...
ansible-playbook playbooks/ue-content-start.yml -e "ndisplay_map=/Game/Some/Other/Map"
